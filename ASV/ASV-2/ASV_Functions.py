...
My_Data = [2, [11,35], 120] #name, coords, distance
...
def Initial_Setup():
	get_comm = get_Communication_Data()
	#get_Coords()
	online = len(get_comm.ASV_Data)	#Online ASV list from get_Communication_Data function
...
def get_Object_Centre():
	get_Coords()
	Object_Centre = ((ASV_Data[0][0][1][1] + ASV_Data[1][0][1][1])/2) #y.ASV0 + y.ASV1
	print(Object_Centre)
